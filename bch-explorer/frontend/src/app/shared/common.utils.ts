...
const roundNumbers = [
  1, 2, 5, 10, 15, 20, 25, 50, 75, 100, 125, 150, 175, 200, 250, 300, 350, 400,
...
export function uncompressDeltaChange(
  block: number,
  delta: MempoolBlockDeltaCompressed
): MempoolBlockDelta {
  return {
    block,
